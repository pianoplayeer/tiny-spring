...
public class AnnoUtilsTest {
    ...
    public void simpleComponent() throws Exception {
        ...
        assertEquals("simpleComponent", ClassUtils.findBeanName(SimpleComponent.class));
    }
    ...
    public void simpleComponentWithName() throws Exception {
        ...
        assertEquals("simpleName", ClassUtils.findBeanName(SimpleComponentWithName.class));
    }
    ...
    public void simpleConfiguration() throws Exception {
        ...
        assertEquals("simpleConfiguration", ClassUtils.findBeanName(SimpleConfiguration.class));
    }
    ...
    public void simpleConfigurationWithName() throws Exception {
        ...
        assertEquals("simpleCfg", ClassUtils.findBeanName(SimpleConfigurationWithName.class));
    }

    @Test
    public void customComponent() throws Exception {
        assertNotNull(ClassUtils.findAnnotation(Custom.class, Component.class));
        assertEquals("custom", ClassUtils.findBeanName(Custom.class));
    }
    ...
    public void customComponentWithName() throws Exception {
        ...
        assertEquals("customName", ClassUtils.findBeanName(CustomWithName.class));
    }
